...
>;
export const SignedIntByteLength = {
...
type SignedIntByteLengths = typeof SignedIntByteLength;
...
>;
export const UnsignedIntByteLength = {
...
type UnsignedIntByteLengths = typeof UnsignedIntByteLength;
...
type FloatByteLengths = typeof FloatByteLength;
...
>;
export const DecimalByteLength = {
    [Marker.decimal_32]: 4,
    [Marker.decimal_64]: 8,
    [Marker.decimal_128]: 16
} as const;
type DecimalByteLengths = typeof DecimalByteLength;
...
>;
export const SmallTupleCapacity = {
    [Marker.tuple_0]: 0,
    [Marker.tuple_1]: 1,
    [Marker.tuple_2]: 2,
    [Marker.tuple_3]: 3,
...
type SmallTupleCapacities = typeof SmallTupleCapacity;

export const LongTupleExtraByte = {
    [Marker.tuple_255]: 1,
...
>;
export const SmallVectorCapacity = {
    [Marker.vector_0]: 0,
    [Marker.vector_1]: 1,
    [Marker.vector_2]: 2,
    [Marker.vector_3]: 3,
...
type SmallVectorCapacities = typeof SmallVectorCapacity;

export const LongVectorExtraByte = {
    [Marker.vector_255]: 1,
    [Marker.vector_65535]: 2,
    [Marker.vector_4G]: 4
} as const;
type LongVectorExtraBytes = typeof LongVectorExtraByte;
...
>;
export const DictExtraByte = {
    [Marker.dict_255]: 1,
    [Marker.dict_65535]: 2,
    [Marker.dict_4G]: 4
} as const;
type DictExtraBytes = typeof DictExtraByte;
...
>;
export const MapExtraByte = {
    [Marker.map_255]: 1,
    [Marker.map_65535]: 2,
    [Marker.map_4G]: 4
} as const;
type MapExtraBytes = typeof MapExtraByte;
...
>;
export const SmallUTF8StringCapacity = {
...
type SmallUTF8StringCapacities = typeof SmallUTF8StringCapacity;

export const LongUTF8StringExtraByte = {
    [Marker.string_utf8_255]: 1,
    [Marker.string_utf8_65535]: 2,
    [Marker.string_utf8_4G]: 4
};
type LongUTF8StringExtraBytes = typeof LongUTF8StringExtraByte;

type SmallUTF8StringSpec = {
    [K in keyof SmallUTF8StringCapacities]: [K, ...FixedLengthBuffer<Byte, SmallUTF8StringCapacities[K]>]
}[keyof SmallUTF8StringCapacities];
